...
public class CCalendarViewOld extends FrameLayout {
    ...
    public CCalendarViewOld(@NonNull Context context) {
        this(context, null);
    }

    public CCalendarViewOld(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CCalendarViewOld(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
